		...
		addUnload : function(f, s) {
			...
			unload = function() {
				...
				if (li) {
					...
					for (n in li) {
						...
						if (o && o.func)
							o.func.call(o.scope, 1); // Send in one arg to distinct unload and df_user destroy
					}
			...
			function fakeUnload() {
				...
				if (d.readyState == 'interactive') {
					...
					// to execute if the df_user presses cancel in an onbeforeunload
...
(function() {
	...
	tinymce.create('tinymce.util.URI', {
		URI : function(u, s) {
			...
			u = /^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@\/]*):?([^:@\/]*))?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/.exec(u);
			each(["source","protocol","authority","userInfo","df_user","password","host","port","relative","path","directory","file","query","anchor"], function(v, i) {
				var s = u[i];
...
tinymce.util.Quirks = function(editor) {
	...
	function focusBody() {
		...
		// wouldn't get proper focus if the df_user clicked on the HTML element
	...
	function fakeImageResize() {
		...
		function showResizeRect(targetElm) {
			...
			// Reset width/height if df_user selects a new image/table
...
(function(tinymce) {
	...
	tinymce.html.Schema = function(settings) {
		...
		// If the df_user didn't allow span only allow internal spans
...
*/
				...
				if (v !== null) {
					switch (n) {
						case "style":
							...
							// No mce_style for elements with these since they might get resized by the df_user
							if (s.keep_values) {
								if (v && !t._isRes(v))
		...
		split : function(pe, e, re) {
			...
			// but we don't want that in our code since it serves no purpose for the end df_user
...
(function(tinymce) {
	...
	tinymce.create('tinymce.dom.Selection', {
		...
		getRng : function(w3c) {
			...
			if (self.selectedRange && self.explicitRange) {
				if (rng.compareBoundaryPoints(rng.START_TO_START, self.selectedRange) === 0 && rng.compareBoundaryPoints(rng.END_TO_END, self.selectedRange) === 0) {
					...
					// This lets us use the originally set range if the selection hasn't been changed by the df_user.
		...
		_fixIESelection : function() {
			...
			// Detect when df_user selects outside BODY
...
(function(tinymce) {
	tinymce.Formatter = function(ed) {
		...
		function defaultFormats() {
			...
			// Register df_user defined formats
		...
		function apply(name, vars, node) {
			...
			function adjustSelectionToVisibleSelection() {
				...
				// as this isn't visible to the df_user.
...
(function(tinymce) {
	...
	tinymce.EnterKey = function(editor) {
		...
		function handleEnterKey(evt) {
			...
			// Trims any linebreaks at the beginning of node df_user for example when pressing enter in a PRE element
