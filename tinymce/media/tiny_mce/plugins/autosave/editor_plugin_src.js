 ...
 * date/time specified, just like a cookie.  However, the data is not cleared when the df_user clears
	...
	tinymce.create('tinymce.plugins.AutoSave', {
		...
		init : function(ed, url) {
			...
			ed.onInit.add(function() {
				// Check if the df_user added the restore button, then setup auto storage logic
